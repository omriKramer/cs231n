...
class CaptioningRNN:
    ...
    def loss(self, features, captions):
        ...
        if self.cell_type == 'rnn':
            dembedding, dh0, grads['Wx'], grads['Wh'], grads['b'] = rnn_backward(dh, rnn_cache)
        else:
            dembedding, dh0, grads['Wx'], grads['Wh'], grads['b'] = lstm_backward(dh, rnn_cache)
        grads['W_embed'] = word_embedding_backward(dembedding, embedding_cache)
        dfeatures, grads['W_proj'], grads['b_proj'] = affine_backward(dh0, c0)
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
